...
global data precipp sigmae rainmean Sr varr Er alpha w Nensemb Neff
global precipp_k rainmean_k Er_k w_k
...
data = load('raindat0_25_deg'); % lonlist latlist hrrainmat

% hrrainmat is {year, day, location}

%% calculate average
datmat = permute(data.hrrainmat,[2 1 3]); % {day, year, location}
...
data.precipp = datmatuse2d; % this is the data matrix [t=year,location]
